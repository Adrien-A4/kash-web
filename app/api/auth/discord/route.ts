                        ...
                        components: [
                            {
                                ...
                                components: [
                                    {
                                        type: 10,
                                        content: `Nice, you've successfully logged in! Welcome to kash', <@${user.id}>!`,
                                    },
                                ],
                            },
                            {
                                ...
                                components: [
                                    ...
                                    },
                                    {
                                        ...
                                        label: 'Join Discord',
                                        url: 'https://discord.gg/pX8eyBuCxf',
                                    },
                                ],
                            },
                        ],
